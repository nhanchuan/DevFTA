<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="NewUser.aspx.cs" Inherits="Admin_Pages_NewUser" %>
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            <li>
                ...
                <a href="../Admin/Pages/Default.aspx">Home</a>
            ...
            <li>
                <a href="../Admin/Pages/NewUser.aspx">New User</a>
            </li>
        </ul>
    </div>
    <!-- END PAGE HEADER-->
    ...
    <div class="row">
        <div class="col-lg-5">
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="txtUsername" CssClass="form-control" AutoPostBack="true" runat="server"></asp:TextBox>
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="txtEmail" CssClass="form-control" AutoPostBack="true" runat="server"></asp:TextBox>
