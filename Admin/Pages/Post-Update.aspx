<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="Post-Update.aspx.cs" Inherits="Admin_Pages_Post_Update" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="../../Admin/Pages/Post-Update.aspx">Update bài viết</a>
            </li>
        </ul>
    </div>
    <!-- END PAGE HEADER-->
