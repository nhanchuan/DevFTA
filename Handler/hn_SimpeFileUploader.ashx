...
public class hn_SimpeFileUploader : IHttpHandler, IReadOnlySessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        UserAdmin ac = context.Session.GetCurrentUser();
        ...
        foreach (string s in context.Request.Files)
        {
            ...
            if (!string.IsNullOrEmpty(fileName))
            {
                ...
                str_image = dateString + "-" + RandomName + numFiles.ToString() + fileExtension;
                ...
                this.images.NewImages(str_image, "images/Uploads/" + dateString + "/" + str_image, ac.ID);
            }
        }
