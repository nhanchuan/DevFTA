<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PostSidebar.ascx.cs" Inherits="Controls_PostSidebar" %>
<!-- BEGIN RIGHT SIDEBAR -->
<div class="col-md-3 col-sm-3 blog-sidebar">
    ...
    <div class="blog-photo-stream margin-bottom-20">
        ...
        <ul class="list-unstyled">
            ...
            <li><a href="#">
                <img alt="" src="../../assets/frontend/pages/img/pics/img1-large.jpg"></a></li>
            <li><a href="#">
                <img alt="" src="../../assets/frontend/pages/img/pics/img2-large.jpg"></a></li>
            <li><a href="#">
